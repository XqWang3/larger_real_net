...
class ValueNet:
    def __init__(self, nb_agent, a_dim, s_dim, obs_wave, obs_wait, use_mf=False, learning_rate=1e-4, tau=0.99, gamma=0.95):
        ...
        #print(self.a_dim, self.s_dim, self.obs_space)
    ...
    def _construct_net(self, trainable=True, reuse=False):
        ...
        net2 = tf.layers.dense(self.feat_input, 64, activation=tf.nn.relu, name='Dense-Obs2', trainable=trainable)
        ...
        if self.use_mf:
            ...
            ##############mean_state
            mean_wave_st_emb = tf.layers.dense(self.mean_wave_st, units=128, activation=tf.nn.relu)
            #h_mean_wave_st = tf.layers.dense(mean_wave_st_emb, units=128, activation=tf.nn.relu)
    ...
    def calc_target_q(self, **kwargs):
        ...
        if self.use_mf:
            ...
            #feed_dict[self.mean_st]= kwargs['mean_s']
    ...
    def act(self, **kwargs):
        ...
        feed_dict = {
            ...
            #self.obs_input: wave_st,
            #self.feat_input: wait_st
